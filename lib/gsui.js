 ...
 *  - separating between the target file ppath to the local file location by specifying file and readStream.
 *
 * gsbt.ssh(extend({
            "sftp":true,
            "mkdirs":false, // if true, will create dirs for "file" if exists.
            "file":__file,  // the path to write to in remote machine
...
exports.wget = function( source, output, opts, callback ){
    ...
    if ( fs.existsSync(output)){
        logger.info("deleting existing [" + output + "]");
